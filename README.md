The Latvian morphology and tools
==========================================

[![Maturity](https://github.com/giellalt/lang-lav/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-lav/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-lav/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-lav/typosreport/)
...
[![Doc build](https://img.shields.io/github/actions/workflow/status/giellalt/lang-lav/docs.yml?logo=github&label=DocCI)](https://github.com/giellalt/lang-lav/actions/workflows/docs.yml)
[![Build Status](https://builds.giellalt.org/api/badge/lang-lav?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/lang-lav/builds/latest)

Download nightly / CI/CD installation packages for testing (contains the core zhfst file(s)):

[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-lav?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-lav?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-lav?platform=mobile&channel=nightly)
...
[LICENSE](https://github.com/giellalt/lang-lav/blob/main/LICENSE). The
...
- [Language specific documentation](https://giellalt.github.io/lang-lav/)
- [General documentation](https://giellalt.github.io/)

Core dependencies
-----------------

In order to compile and use Latvian language morphology and
...
[INSTALL](https://github.com/giellalt/lang-lav/blob/main/INSTALL)
