...
This directory contains source files for the Latvian language morphology
...
-   <https://giellalt.uit.no/lang/lat/LatvianDocumentation.html>
    (analyser)
...
The Latvian language sources can be acquired using [giella SVN
